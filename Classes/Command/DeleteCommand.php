...
/**
 * Generate TCA for Styleguide backend (delete)
 *
 * @internal
 */
#[AsCommand(
    name: 'translation-handling:delete',
    description: 'Delete page tree(s) with translation handling examples'
)]
final class DeleteCommand extends Command
{
    ...
    {
        $this->addArgument('type', InputArgument::OPTIONAL, 'Delete page tree data (valid arguments are "fallback", "strict", "free" and "all")');
    }
